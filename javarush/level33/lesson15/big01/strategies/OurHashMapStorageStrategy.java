...
public class OurHashMapStorageStrategy implements StorageStrategy {
     ...
     * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     The object's hashCode() determines which bucket it goes into, via this expression: object.hashCode() % n,
     where n = the total number of buckets and % is the modulus operator.

     Most often the objects will be well distributed across buckets, but you have no guarantee where they go.
     This depends on the data and the hashCode function.
