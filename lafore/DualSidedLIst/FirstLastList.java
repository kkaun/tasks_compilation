...
public class FirstLastList {
    ...
    { return first==null; }
    // -------------------------------------------------------------
    public void insertFirst(long d, String dd) // Вставка элемента в начало списка
    {
        Link newLink = new Link(d, dd); // Создание нового элемента
    ...
    // -------------------------------------------------------------
    public void insertLast(long d, String dd) // Вставка элемента в конец списка
    {
        Link newLink = new Link(d, dd); // Создание нового элемента
        if( isEmpty() ) // Если список пуст,
            first = newLink; // first --> newLink
